		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#dubaigitdubaigit-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"dubaigitdubaigit-display": {
								"semanticObject": "dubaigitdubaigit",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=dubaigit.dubaigit",
									"url": sap.ui.require.toUrl("dubaigit/dubaigit")
								}
							}
						}
					}
